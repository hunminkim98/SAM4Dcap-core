...
// webviz sits alongside vis; HTTP root is pipeline2, reading JSON from ../vis generated by run_vis
const DATA_PREFIX = "../vis";
...
async function loadTrial(session, trial) {
  // session kept for UI/URL parameters, but paths only depend on trial (vis/<trial>.json)
  const jsonUrl = `${DATA_PREFIX}/${encodeURIComponent(trial)}.json`;
